	...
	<div id="post-body" class="metabox-holder columns-2">
		<div id="post-body-content">
			<div class="settings-wrapper">
				<div class="inside">
					<form name="cadash_form" method="post"
		...
		<p><?php echo "<strong>".__("Site ID:", 'clicky-analytics')." </strong>"; ?><input
						...
						<p><?php echo "<strong>".__("Site Key:", 'clicky-analytics')." </strong>"; ?><input
								type="text" name="ca_sitekey"
								value="<?php echo esc_attr($sitekey); ?>" size="30">
						</p>
						<hr>  
		...
		<p>
							<input name="ca_frontend" type="checkbox" id="ca_frontend"
								value="1"
								<?php if (get_option('ca_frontend')) echo " checked='checked'"; ?> /><?php _e(" show page visits and top searches in frontend (after each article)", 'clicky-analytics' ); ?></p>
		<?php echo "<h2>" . __( 'Backend Settings', 'clicky-analytics' ). "</h2>";?>
		<p>
							<input name="ca_pgd" type="checkbox" id="ca_pgd" value="1"
								<?php if (get_option('ca_pgd')) echo " checked='checked'"; ?> /><?php _e(" show top pages", 'clicky-analytics' ); ?></p>
						<p>
							<input name="ca_rd" type="checkbox" id="ca_rd" value="1"
		...
		<select id="ca_tracking" name="ca_tracking">
						...
						<p>
							<input name="ca_track_username" type="checkbox"
								id="ca_track_username" value="1"
								<?php if (get_option('ca_track_username')) echo " checked='checked'"; ?> /><?php _e(" track usernames", 'clicky-analytics' ); ?></p>
						<p>
							<input name="ca_track_email" type="checkbox" id="ca_track_email"
								value="1"
								<?php if (get_option('ca_track_email')) echo " checked='checked'"; ?> /><?php _e(" track emails", 'clicky-analytics' ); ?></p>
						<p>
							<input name="ca_track_youtube" type="checkbox"
								id="ca_track_youtube" value="1"
								<?php if (get_option('ca_track_youtube')) echo " checked='checked'"; ?> /><?php _e(" track Youtube videos", 'clicky-analytics' ); ?></p>
						<p>
							<input name="ca_track_html5" type="checkbox" id="ca_track_html5"
								value="1"
								<?php if (get_option('ca_track_html5')) echo " checked='checked'"; ?> /><?php _e(" track HTML5 videos", 'clicky-analytics' ); ?></p>
						<hr>
						<p class="submit">
